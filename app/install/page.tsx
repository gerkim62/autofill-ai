      ...
      <div className="container mx-auto p-8 mt-10">
        ...
        <ol className="list-decimal pl-8 mx-auto max-w-lg">
          ...
          <li className="mb-4">
            ...
            <p>On completing the above step, it should automatically take you to the <Link className="font-bold text-blue-500 underline" href="/setup">Setup Page</Link> which has instructions on how to set it up.</p>
          </li>
        </ol>
